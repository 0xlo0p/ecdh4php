srcdir = /Users/loop/Documents/wechat_demo/wechat_ecdh
builddir = /Users/loop/Documents/wechat_demo/wechat_ecdh
top_srcdir = /Users/loop/Documents/wechat_demo/wechat_ecdh
top_builddir = /Users/loop/Documents/wechat_demo/wechat_ecdh
...
AWK = awk
shared_objects_wechat_ecdh = wechat_ecdh.lo
PHP_PECL_EXTENSION = wechat_ecdh
PHP_MODULES = $(phplibdir)/wechat_ecdh.la
PHP_ZEND_EX =
all_targets = $(PHP_MODULES) $(PHP_ZEND_EX)
install_targets = install-modules install-headers
prefix = /usr/local/Cellar/php/7.4.1
exec_prefix = $(prefix)
libdir = ${exec_prefix}/lib
prefix = /usr/local/Cellar/php/7.4.1
phplibdir = /Users/loop/Documents/wechat_demo/wechat_ecdh/modules
phpincludedir = /usr/local/Cellar/php/7.4.1/include/php
CC = cc
CFLAGS = -g -O2
CFLAGS_CLEAN = $(CFLAGS)
CPP = cc -E
...
EXTENSION_DIR = /usr/local/Cellar/php/7.4.1/pecl/20190902
PHP_EXECUTABLE = /usr/local/Cellar/php/7.4.1/bin/php
EXTRA_LDFLAGS =
EXTRA_LIBS =
INCLUDES = -I/usr/local/Cellar/php/7.4.1/include/php -I/usr/local/Cellar/php/7.4.1/include/php/main -I/usr/local/Cellar/php/7.4.1/include/php/TSRM -I/usr/local/Cellar/php/7.4.1/include/php/Zend -I/usr/local/Cellar/php/7.4.1/include/php/ext -I/usr/local/Cellar/php/7.4.1/include/php/ext/date/lib
LFLAGS =
LDFLAGS =
SHARED_LIBTOOL =
